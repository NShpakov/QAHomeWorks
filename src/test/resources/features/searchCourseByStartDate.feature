Feature: Search courses by date
  ...
  Scenario: find and click some course by start date
    ...
    And I find a course by start date "С 30 сентября" and check courseName "Специализация Android-разработчик"
  ...
  Scenario Outline: find and check courses after input date
    ...
    Examples:
      ...
      | 2        | C 30 сентября | Специализация Android-разработчик | Thu Sep 30 00:00:00 MSK 2021 |
